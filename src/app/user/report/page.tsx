      ...
      <main className="px-4 py-6 sm:px-6">
        ...
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <header className="relative overflow-hidden rounded-2xl border border-[#0b5b49] bg-gradient-to-r from-[#075b46] via-[#087458] to-[#0a765a] p-5 text-white shadow-md sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="pointer-events-none absolute -right-10 -top-20 h-48 w-48 rounded-full bg-white/5" />

            <div className="pointer-events-none absolute -bottom-24 right-28 h-48 w-48 rounded-full bg-white/5" />
            ...
            <div className="relative z-10">
              ...
              <p className="mt-1 text-xs sm:text-sm text-emerald-50">

                ผู้แจ้ง: <span className="font-semibold text-white">{reporter}</span>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <section className="rounded-2xl border border-emerald-100 bg-[#f7fbf8] p-5 shadow-sm sm:p-7">
                ...
                <div className="space-y-6">
                  ...
                  {(QUESTIONS[form.category] ?? []).map((question) => (
                    ...
                    <div
                      ...
                      className="space-y-4 rounded-xl border border-emerald-100 bg-white p-4"
                  ...
                  <section className="space-y-5 rounded-2xl border border-emerald-200 bg-[#eef8f2] p-4 sm:p-5">
                  ...
                  {form.urgency === "เร่งด่วนมาก" && (
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-800">
                        หากมีอันตรายทันที โปรดติดต่อหน่วยฉุกเฉิน หรือเจ้าหน้าที่รักษาความปลอดภัยโดยตรง ไม่ควรรอการตอบกลับผ่านระบบ
                      </p>
