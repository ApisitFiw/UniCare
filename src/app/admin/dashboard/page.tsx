        ...
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-5 py-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="rounded-lg border border-emerald-200 px-3 py-2 text-sm font-medium text-emerald-900 hover:bg-emerald-50 cursor-pointer"
            >
              ออกจากระบบ
            </button>
          </div>
      ...
      <main className="mx-auto max-w-6xl space-y-6 px-5 py-8">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            ภาพรวมการจัดการปัญหาเสียงรบกวนและสิ่งแวดล้อม
          </p>
        </div>
        ...
        <section className="grid gap-4 sm:grid-cols-3">
          <Link
            href="/admin/reports"
            className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm hover:border-emerald-400 hover:bg-emerald-50 transition"
          >
            ...
            <p className="mt-2 text-sm text-slate-500">
              ตรวจสอบและจัดการปัญหาที่ผู้ใช้แจ้ง พร้อมระบบแชทซักถาม
            </p>
          </Link>
          ...
          >
            <div className="text-3xl">💬</div>
            <h2 className="mt-3 text-lg font-bold text-emerald-950">
              ติดตามสถานะ & แชทซักถาม
            </h2>
            <p className="mt-2 text-sm text-slate-500">
              จัดการสถานะและสนทนา Realtime กับผู้แจ้งเรื่อง
            </p>
          </Link>
