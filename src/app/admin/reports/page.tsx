                            ...
                            {report.status ===
                              ...
                              <>
                                <button
                                  ...
                                  className="flex items-center gap-1 rounded-full bg-rose-500 px-3 py-2 text-[11px] font-bold text-white"
                                >
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 rounded-full bg-emerald-700 px-3 py-2 text-[11px] font-bold text-white"
                                >
          ...
          <div className="w-full max-w-md rounded-3xl bg-white p-7 shadow-2xl">
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button
                ...
                className="rounded-xl bg-rose-500 px-5 py-3 text-sm font-bold text-white"
              >
                ยืนยันการปฏิเสธ
              </button>
            </div>
